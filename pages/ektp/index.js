      ...
      <div className="page-wrap">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Generate KTP palsu untuk desain, konten, atau hiburan
          </p>
        </div>
        ...
        {activeTab === 'ttd' && (
          <div className="form-card">
            ...
            <div className="sig-wrap">
              <canvas ref={sigRef} className="sig-canvas"
                onMouseDown={sigStart} onMouseMove={sigMove}
                onMouseUp={sigEnd} onMouseLeave={sigEnd}
                onTouchStart={sigStart} onTouchMove={sigMove}
                onTouchEnd={sigEnd} />
            </div>
            ...
            <div className="nav-row" style={{ marginTop: '16px' }}>
              ...
              <button className="btn-generate"
                onClick={generateKTP} disabled={loading}>
                {loading
