      ...
      <nav style={{
        ...
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '52px' }}>
          ...
          <button
            ...
            style={{ color: 'var(--text)', fontSize: '1rem', padding: '0.4rem', background: 'none', border: 'none', cursor: 'pointer' }}
        ...
        {open && (
          <div style={{ background: 'var(--bg)', borderTop: '2px solid var(--border)', padding: '1rem' }}>
            {navLinks.map(link => (
